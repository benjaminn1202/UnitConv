...
function Obj( id )
{
    ...
    /*#obj*/ this.Animate = function( type,callback,time ) { prompt( this.id, "Obj.Animate(\f"+type+"\f"+_Cbm(callback)+"\f"+time ); }
}
...
function Thm( id )
{
    ...
    /*#thm*/ obj.SetTextColor = function( clr ) { prompt( obj.id, "Thm.SetTextColor(\f"+clr ); } 
...
function Skb( id )
{
    ...
    /*#skb*/ obj.SetColorFilter = function( clr,mode ) { prompt( obj.id, "Skb.SetColorFilter(\f"+clr+"\f"+mode ); }
...
function Web( id )
{
    ...
    /*#web*/ obj.Execute = function( code,callback ) { prompt( obj.id, "Web.Execute(\f"+code+"\f"+_Cbm(callback) ); } 
...
function Ynd( id )
{
	...
	/*#ynd*/ obj.SetBackColor = function( clr ) { prompt( obj.id, "Ynd.SetBackColor(\f"+clr ); } 
...
function Ldg( id )
{
	...
	/*#ldg*/ obj.SetBackColor = function( clr ) { prompt( obj.id, "Ldg.SetBackColor(\f"+clr ); } 
...
function Not( id )
{
    ...
    /*#not*/ obj.SetMessage = function( ticker,title,text ) { prompt( obj.id, "Not.SetMessage(\f"+ticker+"\f"+title+"\f"+text ); }
